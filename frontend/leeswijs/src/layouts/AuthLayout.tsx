...
/**
 * Full-screen wrapper for unauthenticated pages (login, onboarding, assessment).
 * Renders a decorative tiled background, the LeesWijs wordmark, and a centred card.
 */

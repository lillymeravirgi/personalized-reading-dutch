...
export const mockReadingSession: ReadingSession = {
  ...
  highlights: [
    // ── unknown (blue) ──────────────────────────────────────────────
    {
      ...
      exampleSentences: [
        "De ontwikkeling van nieuwe medicijnen kost veel tijd.",
        "Hij volgt de ontwikkeling van de situatie op de voet.",
      ],
    ...
    },
    {
      ...
      highlightType: "unknown",
      exampleSentences: [
        "Kunstmatige intelligentie verandert de gezondheidszorg.",
        "Veel bedrijven investeren nu in kunstmatige intelligentie.",
      ],
    ...
    },
    {
      ...
      highlightType: "unknown",
      exampleSentences: [
        "De gegevens worden veilig opgeslagen in de cloud.",
        "Hij analyseerde de gegevens van duizend patiënten.",
      ],
      usageFrequency: "common",
    },
    {
      ...
      highlightType: "unknown",
      exampleSentences: [
        "De verwerking van je aanvraag duurt twee werkdagen.",
        "Snelle verwerking van signalen is essentieel bij zelfrijdende auto's.",
      ],
      usageFrequency: "moderate",
    },
    {
      ...
      highlightType: "unknown",
      exampleSentences: [
        "De nauwkeurigheid van het model is indrukwekkend.",
        "Wetenschappers testen de nauwkeurigheid van de meting.",
      ],
      usageFrequency: "moderate",
    },
    // ── learning (yellow) ────────────────────────────────────────────
    {
      ...
      exampleSentences: [
        "Het onderzoek naar klimaatverandering is urgent.",
        "Ze doet onderzoek aan de universiteit van Amsterdam.",
      ],
      usageFrequency: "common",
    },
    {
      ...
      highlightType: "learning",
      exampleSentences: [
        "Het algoritme sorteert de resultaten op relevantie.",
        "Een goed algoritme kan miljoenen berekeningen per seconde uitvoeren.",
      ],
      usageFrequency: "moderate",
    },
    {
      ...
      exampleSentences: [
        ...
        "Samenwerking is de beste oplossing in dit geval.",
      ],
      usageFrequency: "common",
    },
  ],
...
export const mockFlashcards: FlashcardItem[] = [
  {
    ...
    exampleSentence: "Ik begrijp de uitleg niet helemaal.",
    difficulty: 0.3,
    mode: "review",
  ...
  },
  {
    ...
    dutch: "verandering",
    english: "change",
    exampleSentence: "De verandering in het beleid was onverwacht.",
    difficulty: 0.4,
    mode: "review",
  ...
  },
  {
    ...
    dutch: "samenleving",
    english: "society",
    exampleSentence: "Diversiteit is belangrijk voor de samenleving.",
    difficulty: 0.55,
    mode: "learning",
    nextReviewDate: "2025-10-16T00:00:00Z",
    reviewInterval: "1d",
  },
  {
    ...
    dutch: "gevolg",
    english: "consequence",
    exampleSentence: "Het gevolg van zijn beslissing was groot.",
    difficulty: 0.45,
    mode: "learning",
    nextReviewDate: "2025-10-16T00:00:00Z",
    reviewInterval: "1d",
  },
  {
    ...
    dutch: "invloed",
    english: "influence",
    exampleSentence: "Muziek heeft veel invloed op onze stemming.",
    difficulty: 0.35,
    mode: "review",
  ...
  },
  {
    ...
    dutch: "beschikbaar",
    english: "available",
    exampleSentence: "Is de manager nu beschikbaar voor een gesprek?",
    difficulty: 0.5,
    mode: "learning",
    nextReviewDate: "2025-10-16T00:00:00Z",
    reviewInterval: "1d",
  },
  {
    ...
    dutch: "verwachten",
    english: "to expect",
    exampleSentence: "We verwachten morgen regen.",
    difficulty: 0.3,
    mode: "review",
  ...
  },
  {
    ...
    exampleSentence: "De overheid nam strenge maatregelen tegen vervuiling.",
    difficulty: 0.65,
    mode: "learning",
    nextReviewDate: "2025-10-16T00:00:00Z",
    reviewInterval: "2d",
  },
  {
    ...
    exampleSentence: "Er is geen bewijs dat hij schuldig is.",
    difficulty: 0.42,
    mode: "review",
  ...
  },
  {
    ...
    dutch: "verbeteren",
    english: "to improve",
    exampleSentence: "Ze wil haar Nederlands verbeteren door elke dag te lezen.",
    difficulty: 0.28,
    mode: "review",
  ...
  },
  {
    ...
    exampleSentence: "De temperatuur stijgt elk jaar een beetje.",
    difficulty: 0.38,
    mode: "learning",
    nextReviewDate: "2025-10-16T00:00:00Z",
    reviewInterval: "1d",
  },
  {
    ...
    exampleSentence: "De toepassing van AI in de zorg groeit snel.",
    difficulty: 0.6,
    mode: "learning",
    nextReviewDate: "2025-10-17T00:00:00Z",
    reviewInterval: "2d",

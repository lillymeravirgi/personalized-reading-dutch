...
import { getAssessmentBatch, submitAssessment } from "../services/api";
...
export default function AssessmentPage() {
  ...
  async function handleNextBatch() {
    ...
    // Update user's CEFR level in the store
    if (user) {
      setUser({ ...user, cefrLevel: assessmentResult.estimatedLevel as ReturnType<typeof inferLevel> });
    }
